...
| Product built | A working multi-property hotel PMS: TypeScript API (45 data models, 98 documented endpoints across 126 operations), React web app (15 screens under 13 nav sections), demo seed with a Hurghada resort and a Makkah hotel, 59 passing automated tests |
...
Automated tests (`npm test`, 59 tests in 5 files) cover date and Hijri handling, tax maths, restrictions and
